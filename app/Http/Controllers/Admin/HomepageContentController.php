...
class HomepageContentController extends Controller
{
    private array $fields = [
        ...
        'home_price_label' => 'Fiber optic networking and connectivity equipment',
        ...
        'home_whatsapp_url' => 'https://wa.me/254704991492?text=Hello%2C%20I%20want%20Fiber%20Optics%20Kenya%20installation%20support.',
        'home_services_title' => "FIBER OPTICS KENYA\nPRODUCTS",
        'home_services_subtitle' => 'Fiber optic products, networking equipment, and installation support across Kenya.',
        'home_kit_title_1' => 'FIBER OPTIC CABLES',
        'home_kit_text_1' => 'Fiber optic cables and accessories for homes, offices, estates, and business networks in Kenya.',
        'home_kit_price_1' => 'KES 55,000.00',
        'home_kit_title_2' => 'ROUTERS AND SWITCHES',
        'home_kit_text_2' => 'Reliable routing and switching equipment for stable local and internet connectivity.',
        'home_kit_price_2' => 'KES 30,000.00',
        'home_kit_title_3' => 'INSTALLATION SUPPORT',
        ...
        'home_feature_text' => 'High-speed fiber optic networking support for homes, offices, estates, and business sites.',
        ...
        'home_why_text' => 'Fiber optic performance depends on clean cabling, correct routing, proper terminations, and stable equipment. A professional install reduces downtime, weak Wi-Fi zones, and messy repairs later.',
        'home_areas_title' => 'Need fiber optic networking installed?',
        'home_areas_text' => 'Send your location and site type. We will help you plan the cleanest installation route.',
        'home_testimonials_title' => 'Installation support for reliable fiber optic networking',
        'home_empty_testimonials' => '<h1>Fiber Optics Kenya: Networking Products and Installation Support</h1><h2>Introduction</h2><p><strong>Fiber Optics Kenya</strong> helps homes, businesses, schools, estates, and organizations access reliable networking products and installation support.</p>',
        'home_footer_text' => 'Networking products, installation support, and connectivity planning across Kenya.',
