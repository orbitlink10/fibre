...
require __DIR__.'/armoured_fiber_cable_kenya_article.php';

$baseUrl = 'https://fiberopticskenya.co.ke';
$email = 'admin@demo.com';
$password = 'admin123';
$article = armoured_fiber_cable_kenya_article();
...
$fields = [
    ...
    'image' => new CURLFile($heroPath, 'image/png', 'armoured-fiber-cable-kenya-hero.png'),
];
...
if ($status !== 302) {
    file_put_contents(__DIR__.'/../storage/logs/armoured_fiber_remote_publish_failed.html', $body);
    throw new RuntimeException("Post submission returned HTTP {$status}. Response saved to storage/logs/armoured_fiber_remote_publish_failed.html");
}
